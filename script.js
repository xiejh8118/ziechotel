...
const I18N_TEXT = {
  en: {
    ...
    "US$200/月起，适合长期居住 →":
      "From US$200/month for long-term stays →",
    "团队接待、长包房、协议合作 →":
...
Object.assign(I18N_TEXT.kh, {
  ...
  "月租包含哪些费用？": "ការជួលប្រចាំខែរួមបញ្ចូលថ្លៃអ្វីខ្លះ?", "月租公寓US$200/月起，费用包含、押金及水电标准以确认方案为准។": "អាផាតមិនចាប់ពី US$200/ខែ។ ថ្លៃរួម ប្រាក់កក់ ទឹក និងអគ្គិសនី អាស្រ័យលើផែនការដែលបានបញ្ជាក់។",
  ...
  "US$35 / 晚": "US$35 / យប់", "US$45 / 晚": "US$45 / យប់", "US$65 / 晚": "US$65 / យប់", "US$80 / 晚": "US$80 / យប់", "US$200 / 月起": "ចាប់ពី US$200 / ខែ",
  ...
  "月租公寓 | ZIEC HOTEL": "អាផាតមិនប្រចាំខែ | ZIEC HOTEL", "US$200 / month 起": "ចាប់ពី US$200 / ខែ", "US$200/月起": "ចាប់ពី US$200/ខែ",
...
Object.assign(I18N_TEXT.kh, {
  ...
  "US$200/月具体包含服务：请咨询客服确认":"សេវាដែលរួមក្នុង US$200/ខែ៖ សូមបញ្ជាក់ជាមួយបុគ្គលិក", "最短租期、押金、水电费：请咨询客服确认":"រយៈពេលជួលអប្បបរមា ប្រាក់កក់ ទឹក និងភ្លើង៖ សូមបញ្ជាក់ជាមួយបុគ្គលិក", "网络、停车、清洁及发票：请咨询客服确认":"អ៊ីនធឺណិត ចំណត ការសម្អាត និងវិក្កយបត្រ៖ សូមបញ្ជាក់ជាមួយបុគ្គលិក",
...
Object.assign(I18N_TEXT.kh, {
  ...
  "US$200/月起，适合长期居住 →":"ចាប់ពី US$200/ខែ សម្រាប់ការស្នាក់នៅយូរ →", "1间":"1 បន្ទប់", "2间":"2 បន្ទប់", "3间":"3 បន្ទប់", "1位":"1 នាក់", "2位":"2 នាក់", "3位":"3 នាក់", "/晚":"/យប់", "/ 晚":"/ យប់", "/月起":"/ខែឡើង", "长住推荐":"ណែនាំសម្រាប់ស្នាក់យូរ",
...
Object.assign(I18N_TEXT.en, {
  ...
  "住宿、月租、企业团房与到店路线，由客服根据实际需求确认。":"Contact support to confirm hotel stays, monthly rentals, corporate group accommodation and directions.",
  "运营主体：":"Operator:", "服务城市：":"Service City:", "柬语／酒店前台：":"Khmer / Hotel Reception:", "中文客服／WhatsApp：":"Chinese Support / WhatsApp:", "邮箱：":"Email:",
  "Google Maps定位已经确认；点击地图可直接导航。需要中、英、柬文地址时，请联系前台发送。":"The Google Maps location is confirmed. Open the map for directions, or contact reception for the address in Chinese, English or Khmer.",
  "打开 Google Maps 导航":"Open Google Maps", "WhatsApp中文咨询":"WhatsApp Support", "拨打酒店前台":"Call Hotel Reception", "点击打开酒店准确定位 →":"Open the Confirmed Hotel Location →",
  "ZIEC 平台管理后台":"ZIEC Platform Administration", "供应商、酒店房源、采购询价与 AI 客服统一管理。":"Manage suppliers, hotel rooms, purchase enquiries and AI support in one place.",
  "供应商管理":"Supplier Management", "酒店房源":"Hotel Rooms", "采购询价":"Purchase Enquiries", "AI统一管理":"AI Management",
  "US$200/月起，适合长期居住 →":"From US$200/month for long-term stays →", "US$200":"US$200", "US$200 / 月起":"From US$200 / month", "US$200 / month 起":"From US$200 / month", "US$200/月起":"From US$200/month",
  "月租公寓US$200/月起，费用包含、押金及水电标准以确认方案为准。":"Monthly apartments start from US$200 per month. Included services, deposit and utility charges are subject to the confirmed offer.",
  "US$200/月具体包含服务：请咨询客服确认":"Please confirm the services included in the US$200 monthly rate with support."
});
Object.assign(I18N_TEXT.kh, {
  "联系酒店与到店导航":"ទាក់ទងសណ្ឋាគារ និងមើលផ្លូវទៅកាន់ទីតាំង",
  "住宿、月租、企业团房与到店路线，由客服根据实际需求确认。":"សូមទាក់ទងបុគ្គលិកដើម្បីបញ្ជាក់ការស្នាក់នៅ ការជួលប្រចាំខែ បន្ទប់សម្រាប់ក្រុមហ៊ុន និងផ្លូវទៅសណ្ឋាគារ។",
  "运营主体：":"ប្រតិបត្តិករ៖", "服务城市：":"ទីក្រុងសេវាកម្ម៖", "柬语／酒店前台：":"ភាសាខ្មែរ / ផ្នែកទទួលភ្ញៀវ៖", "中文客服／WhatsApp：":"សេវាភាសាចិន / WhatsApp៖", "邮箱：":"អ៊ីមែល៖",
  "Google Maps定位已经确认；点击地图可直接导航。需要中、英、柬文地址时，请联系前台发送。":"ទីតាំង Google Maps បានបញ្ជាក់។ ចុចផែនទីដើម្បីមើលផ្លូវ ឬទាក់ទងផ្នែកទទួលភ្ញៀវសម្រាប់អាសយដ្ឋានជាភាសាចិន អង់គ្លេស ឬខ្មែរ។",
  "打开 Google Maps 导航":"បើក Google Maps", "WhatsApp中文咨询":"ទាក់ទងតាម WhatsApp", "拨打酒店前台":"ហៅផ្នែកទទួលភ្ញៀវ", "点击打开酒店准确定位 →":"បើកទីតាំងសណ្ឋាគារដែលបានបញ្ជាក់ →",
  "ZIEC 平台管理后台":"ប្រព័ន្ធគ្រប់គ្រងវេទិកា ZIEC", "供应商、酒店房源、采购询价与 AI 客服统一管理。":"គ្រប់គ្រងអ្នកផ្គត់ផ្គង់ បន្ទប់សណ្ឋាគារ សំណើទិញ និងសេវា AI នៅកន្លែងតែមួយ។",
  "供应商管理":"ការគ្រប់គ្រងអ្នកផ្គត់ផ្គង់", "酒店房源":"បន្ទប់សណ្ឋាគារ", "采购询价":"សំណើតម្លៃទិញ", "AI统一管理":"ការគ្រប់គ្រង AI",
  "US$200/月起，适合长期居住 →":"ចាប់ពី US$200/ខែ សម្រាប់ការស្នាក់នៅយូរ →", "US$200":"US$200", "US$200 / 月起":"ចាប់ពី US$200 / ខែ", "US$200 / month 起":"ចាប់ពី US$200 / ខែ", "US$200/月起":"ចាប់ពី US$200/ខែ",
  "月租公寓US$200/月起，费用包含、押金及水电标准以确认方案为准。":"អាផាតមិនចាប់ពី US$200/ខែ។ សេវាដែលរួម ប្រាក់កក់ និងថ្លៃទឹកភ្លើង អាស្រ័យលើការបញ្ជាក់ចុងក្រោយ។",
  "US$200/月具体包含服务：请咨询客服确认":"សូមបញ្ជាក់ជាមួយបុគ្គលិកអំពីសេវាដែលរួមក្នុងតម្លៃ US$200/ខែ។"
});
