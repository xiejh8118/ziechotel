...
const FAQ = [
  {
    keys: ["客房", "房价", "住宿", "双床", "vip", "三室", "套房"],
    answer:
      "中鼎国际酒店提供豪华大床房US$35/晚、豪华双床房US$35/晚、家庭两房一厅US$65/晚、家庭三房一厅US$80/晚、三卧室套房US$80/晚、行政大床房US$45/晚、行政双床房US$45/晚及月租公寓。最终房态与价格请通过入住需求表或WhatsApp确认。",
  },
  {
    keys: ["月租", "公寓", "长住"],
    answer:
      "月租公寓适合商务人士、企业员工和长期驻柬客户，US$200/月起，可咨询企业长租方案。",
  },
  {
    keys: ["供应商", "入驻", "新增"],
    answer:
  ...
  try {
    const r = await fetch(`${cfg.base_url}/responses`, {
      ...
      body: JSON.stringify({
        ...
        instructions:
          cfg.system_prompt ||
          "你是中鼎国际酒店和中鼎供应链平台的中文客服。回答简洁、准确，不虚构价格或服务。酒店参考信息：豪华大床房US$35/晚、豪华双床房US$35/晚、家庭两房一厅US$65/晚、家庭三房一厅US$80/晚、三卧室套房US$80/晚、行政大床房US$45/晚、行政双床房US$45/晚；WhatsApp +855 018 995 8899。供应商入驻需审核，采购方可发布询价。无法确认时引导联系人工。",
        input: q,
