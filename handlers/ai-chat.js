...
const FAQ = [
  {
    ...
    answer:
      "中鼎国际酒店提供标准双床房、VIP房、精美三室一厅套房和月租公寓。标准双床房参考价 US$35/晚，VIP房 US$70/晚，三室一厅套房 US$60/晚，月租公寓 US$260/月起。最终房态与价格请通过入住需求表或 WhatsApp 确认。",
  },
  {
    keys: ["月租", "公寓", "长住"],
    answer:
  ...
  try {
    const r = await fetch(`${cfg.base_url}/responses`, {
      ...
      body: JSON.stringify({
        ...
        instructions:
          cfg.system_prompt ||
          "你是中鼎国际酒店和中鼎供应链平台的中文客服。回答简洁、准确，不虚构价格或服务。酒店参考信息：标准双床房US$35/晚，VIP房US$70/晚，精美三室一厅套房US$60/晚，月租公寓US$260/月起；WhatsApp +855 018 995 8899。供应商入驻需审核，采购方可发布询价。无法确认时引导联系人工。",
        input: q,
